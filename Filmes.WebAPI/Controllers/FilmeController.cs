...
public class FilmeController : ControllerBase
{
    ...
    private object novoFilme;
    private object filmeBuscado;
    private string pastaRelativa;
    ...
    public async Task<IActionResult> Post([FromForm]FilmeDTO filme)
    {
        if (String.IsNullOrWhiteSpace(filme.Nome))
            return BadRequest("É Obrigatorio que o filme tenha o nome e Genero");
    ...
    public async Task<IActionResult> Put(Guid id, FilmeDTO filmeAtualizado)
    {
        ...
        if (filmebuscado.IdGenero != filmeAtualizado.IdGenero.ToString())
        ...
        if (!String.IsNullOrEmpty(filmeBuscado.imagens))
        {
    ...
    public IActionResult Delete(Guid id)
    {
        ...
        if (!String.IsNullOrEmpty(caminhoPasta.Imagem))
        {
